"""
H6 ENHANCED - Horizon-Specific Feature Engineering
...
print("="*70)
print(f"H6 ENHANCED - HORIZON-SPECIFIC FEATURES")
print("="*70)
...
# After global shift(1): at row t, these become inf[t-k-1]
